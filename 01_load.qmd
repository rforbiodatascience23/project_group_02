...
raw_coexpression <- read_excel("data/_raw/pone.0183928.s001.xlsx", na = c(" ", "NA"))
raw_regulators_before <- read_excel("data/_raw/pone.0183928.s003.xlsx", na = c(" ", "NA"))
raw_regulators_after <- read_excel("data/_raw/pone.0183928.s003.xlsx",2, na = c(" ", "NA"))
...
load_coexpression <- write_tsv(coexpression_raw, "data/coexpression_load.tsv", append = FALSE, col_names = TRUE)
load_regulators_before <- write_tsv(regulators_before_raw, "data/regulators_b_load.tsv", append = FALSE, col_names = TRUE)
Load_regulators_after <- write_tsv(regulators_after_raw, "data/regulators_a_load.tsv", append = FALSE, col_names = TRUE)
