...
coexpression_load <- write_tsv(coexpression_raw, "data/01_coexpression_load.tsv", append = FALSE, col_names = TRUE)
regulators_before_load <- write_tsv(regulators_before_raw, "data/01_regulators_before_load.tsv", append = FALSE, col_names = TRUE)
regulators_after_load <- write_tsv(regulators_after_raw, "data/01_regulators_after_load.tsv", append = FALSE, col_names = TRUE)
