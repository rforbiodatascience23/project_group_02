...
The upstream regulators each have an influence on several target molecules. To investigate whether this influence was affected by the treatment a plot indicating the change of the number of target molecules before and after treatment was created.
...
The plot shows that the number of target molecules the upstream regulators influence does change after treatment. There are cases of both increasing, decreasing and unchanged number of target molecules. This highlight the shift in the behavior of the upstream regulators after treatment, which is relevant information when assessing the effect of the treatment, its possible benefits and side effects.

### Biological context of the target molecules

The analysis of the expression data revealed the following regulators interesting ...... That together with the above analysis of the target molecules makes the regulators ..., ..., ... interesting to look at as potential drug targets. As mentioned the modules in the co-expression dataset represent possible biological pathways. Therefore a further analysis was performed to look into which modules the target molecules of the candidates regulators belonged to.
...
The results from all of the candidates was merged into a small dataframe called "module_analysis".
...
From the plot we can get an idea of which regulator influences specific biological pathways. Candidate 1 seems to ... Candidate 2 seems to ... Candidate 3 seems to ... It might not be prefered to have a change in to many pathways.....
