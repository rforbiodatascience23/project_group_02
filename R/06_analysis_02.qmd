...
```{r}
candidate_1 <- module_counter(target_aug, "S100A9")
candidate_2 <- module_counter(target_aug, "TGFB1")
candidate_3 <- module_counter(target_aug, "TLR2")
```
