...
The analysis of the expression data, together with the target molecule analysis above, revealed the following interesting regulators: S100A9, TGFB1, and TLR2. They all have a significant change in expression and in the number of target molecules. These regulators could be potential drug targets.
