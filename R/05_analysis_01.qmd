...
To depict which upstream regulators are expressed significantly different from healthy control group, two scatter plots are made. One plot comparing patients before treatment and the other comparing patients after treatment to the control group. The significant genes are depicted in turquoise and insignificant in red.
...
\<\<\<\<\<\<\< HEAD The two scatter plots show that there are significantly differential expressed upstream regulators, both before and after treatment. The criteria for being significant was defined by a p-value \> -log10(0.05) and a log-ratio gene expression between -1.5 and 1.5, indicated by the dotted black lines.
