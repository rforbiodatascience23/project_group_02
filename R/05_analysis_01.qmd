...
Both unique and common significant upstream regulators are found in both plots. One example of an upstream regulator that both plots have in common could be TGFB1, found in the top left corner in both plots. All the common upstream regulators will be further analysed to answer which upstream regulators are influenced by the treatment.
