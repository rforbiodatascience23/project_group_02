...
Read in the loaded datafiles  
```{r}
#| label: load in data
coexpression_clean <- read_tsv("../data/01_coexpression_load.tsv",
                               show_col_types = FALSE)

regulators_before_clean <- read_tsv("../data/01_regulators_before_load.tsv",
                                    show_col_types = FALSE, skip = 1)

regulators_after_clean <- read_tsv("../data/01_regulators_after_load.tsv",
                                   show_col_types = FALSE, skip = 1)
```
...
#### Cleaning the two dataframes describing upstream regulators before and after treatment

Function that fixes renames headers and ensures all floats in the dataframe is intepreted as numeric values and selects relevant columns for further analysis
```{r}
...
Saving the clean dataframes as tsv files
```{r}
write_tsv(coexpression_clean,
          "../data/02_coexpression_clean.tsv")
