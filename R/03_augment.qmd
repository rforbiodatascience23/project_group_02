...
```{r}
expr_data_before_unfiltered_aug <- read_tsv("../data/02_expr_data_before_unfiltered_clean.tsv.gz",
                               show_col_types = FALSE)

expr_data_after_unfiltered_aug <- read_tsv("../data/02_expr_data_after_unfiltered_clean.tsv.gz",
                               show_col_types = FALSE)
```
...
write_tsv(expr_data_before_unfiltered_aug,
          "../data/03_expr_data_before_unfiltered_aug.tsv.gz")

write_tsv(expr_data_after_unfiltered_aug,
          "../data/03_expr_data_after_unfiltered_aug.tsv.gz")
```
