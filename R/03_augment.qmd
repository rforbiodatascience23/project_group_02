...
# Load in the clean datafiles  
=======
>>>>>>> 486c782e50660b4ef0b0a37995dcaeb338cf10c1
```{r}
...
target_aug <- read_tsv("../data/02_target_clean.tsv",
                       show_col_types = FALSE)
```
#### No changes to the dataframe containing the coexpression data

<<<<<<< HEAD
#### Augmenting the dataframe reflecting the gene expression levels

Adding a varaible that indicates weather a regulator was up or downregulated,
before and after trearment 
```{r}
...
Number of target molecules before treatment per regulator
```{r}
...
<<<<<<< HEAD
Number of target molecules after treatment per regulator
```{r}
target_aug <- target_aug |> 
  rowwise() |> 
