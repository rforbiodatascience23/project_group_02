...
The function used below creates a column that indicates whether a datapoint is significant or not. Furthermore, a -log10 transformation of the p-values is added.
