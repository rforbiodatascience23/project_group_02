...
target_intersect_clean <- all_target_data(regulators_before_clean, regulators_after_clean)
expr_intersect_clean <- all_expression_data(regulators_before_clean, regulators_after_clean)
...
target_intersect_clean <- split_cells(target_intersect_clean, target_molecules_in_dataset_before, "before")
target_intersect_clean <- split_cells(target_intersect_clean, target_molecules_in_dataset_after, "after")
