...
#| label: Correct headers of table 3, before treatment
#| echo: false

regulators_before_load <- regulators_before_load |>
...
regulators_after_load <- regulators_after_load |>
...
```{r}
#| label: pivot longer 
pivot_after_treatment <- clean_regulators_after|> 
